...
class TestList(unittest.TestCase):
    ...
    @patch('fun_with_collections.basic_list_exceptions.get_input', return_value='ab')  # patch function for input
    ...
    @patch('fun_with_collections.basic_list_exceptions.get_input', return_value='-4')  # patch function for input
    def test_make_list_below_range(self, input):  # pass input
        with self.assertRaises(ValueError):  # this is familiar
            basic_list_exception.make_list()  # call the function!

    @patch('fun_with_collections.basic_list_exceptions.get_input', return_value='51')  # patch function for input
