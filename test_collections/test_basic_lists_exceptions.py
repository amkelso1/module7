...
class MyTestCase(unittest.TestCase):
    @patch('fun_with_collections.basic_lists_exception.get_input', return_value='5')
    def test_make_list(self, input):
        self.assertEqual(basic_list_exception.make_list(), [5, 5, 5])


class TestList_nonNumeric(unittest.TestCase):
    @patch('fun_with_collections.basic_lists_exception.get_input', return_value='ab')
...
class TestList_below(unittest.TestCase):
    @patch('fun_with_collections.basic_lists_exception.get_input', return_value='-4')
...
class TestList_above(unittest.TestCase):
    @patch('fun_with_collections.basic_lists_exception.get_input', return_value='52')
